...
print(new_data)
gray_squirrels_count = original_data[original_data["Primary Fur Color"] == "Gray"]
cinnamon_squirrels_count = original_data[original_data["Primary Fur Color"] == "Cinnamon"]
black_squirrels_count = original_data[original_data["Primary Fur Color"] == "Black"]